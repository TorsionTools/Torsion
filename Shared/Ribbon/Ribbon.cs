...
namespace Torsion.Ribbon
{
    class AppRibbon
    {
        internal static void AddPanel(UIControlledApplication RevitApplication)
        {
            ...
            BitmapImage FindReplaceImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/FindReplace100x100.png"));
            BitmapImage SheetCapitalizeImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/ToUpper100x100.png"));
            BitmapImage SheetSelectionImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/SheetSelection100x100.png"));
            BitmapImage SheetTitleblockKeyPlanImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/SheetTitleblockKeyPlan100x100.png"));
            BitmapImage SheetViewRefSheetImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/SheetViewRefSheet100x100.png"));
            BitmapImage ViewsViewLegendCopyImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/ViewLegendCopy100x100.png"));
            BitmapImage ViewsViewScheduleCopyImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/ViewScheduleCopy100x100.png"));
            BitmapImage ViewsLinkedViewsImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/LinkedView100x100.png"));
            BitmapImage ViewsLinkedViewsUpdateImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/LinkedViewUpdate100x100.png"));
            BitmapImage ViewsViewDeleteunplacedImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/ViewDeleteUnplaced100x100.png"));
            BitmapImage ToolsWarningsImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/Warning100x100.png"));
            BitmapImage ToolsElemOfCategoryImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/ComponentInfo100x100.png"));
            BitmapImage ToolsSheetLegendMultipleImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/SheetLegendToMultiple100x100.png"));
            BitmapImage ToolsSheetScheduleMultipleImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/SheetScheduleToMultiple100x100.png"));
            BitmapImage ToolsFamilyMultipleSharedParametersImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/MultipleSharedParameters100x100.png"));
            BitmapImage SquareTImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/SquareT100x100.png"));
            BitmapImage ViewsChangeViewReferenceImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/ChangeViewReference100x100.png"));
            BitmapImage MEPSpacesFromLinkedRoomsImage = new BitmapImage(new Uri($"pack://application:,,,/{AppVars.AssemblyName};component/Images/CreateSpaces100x100.png"));
